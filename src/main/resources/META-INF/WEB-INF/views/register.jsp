	...
	<div class="content-form-page">
		<div class="row">
			<div class="col-md-7 col-sm-7">
				<form action="${pageContext.request.contextPath}/register" method="post" class="form-horizontal form-without-legend" role="form">
					...
					<div class="form-group">
						<label for="username" class="col-lg-4 control-label">Tài
							khoản <span class="require">*</span>
						</label>
						<div class="col-lg-8">
					...
					<div class="form-group">
						<label for="fullname" class="col-lg-4 control-label">Họ và
					...
					<div class="form-group">
						<label for="phone" class="col-lg-4 control-label">Số điện
							thoại <span class="require">*</span>
						</label>
						<div class="col-lg-8">
